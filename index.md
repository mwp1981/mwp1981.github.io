---
# 仅删除layout: default（核心错误），其余SEO配置完全保留
...
<head>
  ...
  <!-- 保留：SoftwareApplication结构化数据（仅删除非法HTML注释，其余完全保留）-->
  <script type="application/ld+json">
  {
    ...
    "operatingSystem": "Windows 10 and later",
...
<body>
  ...
  <!-- 主内容区：博文模块**完全保留**，无任何删减 -->
  <main>
    <!-- 最新博文模块：保留所有原有逻辑（置顶、遍历、无博文提示） -->
    ...
    <!-- 软件介绍模块：**完全保留README.md加载逻辑**，无任何修改 -->
    <section id="software-introduction">
      ...
      {% comment %} 加载README.md内容（若存在）- 完全保留原有逻辑 {% endcomment %}
