...
<p style="text-align: center; margin: 1.5rem 0;">
  <img src="/assets/images/zingto_frame_capture_module_Screenshot_1.png" alt="the girl in the dress jumping to the highest point" width="700" style="height: auto; border: 1px solid #eee; border-radius: 6px;">
</p>
...
<p style="text-align: center; margin: 1.5rem 0;">
  <img src="/assets/images/zingto_frame_capture_module_Screenshot_2.png" alt="the girl in jeans jumping to the highest point" width="700" style="height: auto; border: 1px solid #eee; border-radius: 6px;">
</p>
...
<p style="text-align: center; margin: 1.5rem 0;">
  <img src="/assets/images/zingto_frame_capture_module_Screenshot_3.png" alt="both girls jumping at the same time" width="700" style="height: auto; border: 1px solid #eee; border-radius: 6px;">
</p>
